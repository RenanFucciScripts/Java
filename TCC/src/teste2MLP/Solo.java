...
public class Solo {
	...
	static TransferFunctionType fAtiv =TransferFunctionType.GAUSSIAN;	
	...
	public static void main(String[] args) {
		try {
			...
			String dirArq1 = "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/SaoLourenco Bandas Spectrais/amostraSolo.txt";
			FileReader arq1 =  new FileReader(dirArq1);
			BufferedReader leitura1 =  new BufferedReader(arq1);
			String linha1 =  leitura1.readLine();
			String[] div1; 

			String dirArq2 = "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/SaoLourenco Bandas Spectrais/amostraVeget.txt";
			FileReader arq2 =  new FileReader(dirArq2);
			BufferedReader leitura2 =  new BufferedReader(arq2);
			String linha2 =  leitura2.readLine();
			String[] div2; 

			String dirArq3 = "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/SaoLourenco Bandas Spectrais/amostraAgua.txt";
			...
			neuralNetwork1.save("C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/SaoLourenco Bandas Spectrais/Classificacao/"+indices+"/"+cls.getClass().getSimpleName()+"/solo ("+fAtiv.getTypeLabel()+").nnet");
			...
			methds.gravarImagemRed(imgsaolournecoSolo, "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/SaoLourenco Bandas Spectrais/Classificacao/"+indices+"/"+cls.getClass().getSimpleName()+"/", "solo ("+fAtiv.getTypeLabel()+") train="+segtrain+" exe="+segexec);
		}catch(Exception ex){
			ex.printStackTrace();
		}
	}
