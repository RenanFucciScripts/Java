...
public class Agua {
	...
	public static void main(String[] args) {
		try {
			...
			methds.gravarImagemBlue(imgsaolournecoAgua, "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/SaoLourenco Bandas Spectrais/Classificacao/"+indices+"/"+cls.getClass().getSimpleName()+"/", "agua ("+fAtiv.getTypeLabel()+") train="+segtrain+" exe="+segexec);
		}catch(Exception ex){
			ex.printStackTrace();
		}
	}
