...
public class RegraDelta {

	public static void main(String[] args) {
		try {

			MetodosRNA methds = new MetodosRNA();
			NeuralNetwork neuralNetwork= new Perceptron(2, 1, TransferFunctionType.SIGMOID);
			...
			neuralNetwork.save("C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/Execucao/Perceptron Linear/ndvi_evi.nnet");
			...
			while(linha2!=null){
				...
				double[] vetDescritores={ndvi,evi};
			...
			methds.gravarImagem(imgCodrasa, "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/Execucao/Perceptron Linear/", "imgcodrasa");
			...
			methds.gravarImagem(imgsaolourneco, "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/Execucao/Perceptron Linear/", "imgsaolourenco");
