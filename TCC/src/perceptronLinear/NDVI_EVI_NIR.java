...
public class NDVI_EVI_NIR {
	public static void main(String[] args) {
		try {

			MetodosRNA methds = new MetodosRNA();
			NeuralNetwork neuralNetwork= new Perceptron(3, 1, TransferFunctionType.STEP);
			...
			*/
			...
			neuralNetwork.save("C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/Execucao/NDVI, EVI e NIR/ndvi_evi_nir.nnet");
			...
			while(linha2!=null){
				...
				double[] vetDescritores={ndvi,evi,nir};
			...
			methds.gravarImagem(imgCodrasa, "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/Execucao/NDVI, EVI e NIR/", "imgcodrasa");
		...
		//	methds.gravarImagem(imgsaolourneco, "D:/Usuarios/renan.fucci/Desktop/Imagens/Execucao/NDVI, EVI e NDWI/", "imgsaolourenco");
			methds.gravarImagem(imgsaolourneco, "C:/Users/Renan Fucci/Dropbox/Projeto - Embrapa/Imagens/Execucao/NDVI, EVI e NIR/", "imgsaolourenco");
