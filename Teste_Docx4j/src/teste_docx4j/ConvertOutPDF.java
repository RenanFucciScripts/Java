...
public class ConvertOutPDF extends AbstractSample {
    ...
    static {
        ...
        inputfilepath = "C:/Users/_/Dropbox/Estante Magica_Renan_Fucci/Pasta_Renan_Fucci"
                + "/2016-10-10/teste-docx4j/rf15 - Teste Renan PNG.pptx";
        saveFO = true;
    }
    ...
    public static void main(String[] args)
         ...
         * Demo of PDF output.
         *
         * PDF output is via XSL FO. First XSL FO is created, then FOP is used
         * to convert that to PDF.
         *
         * Don't worry if you get a class not found warning relating to batik.
         * It doesn't matter.
         *
         * If you don't have logging configured, your PDF will say "TO HIDE
         * THESE MESSAGES, TURN OFF debug level logging for
         * org.docx4j.convert.out.pdf.viaXSLFO". The thinking is that you need
         * to be able to be warned if there are things in your docx which the
         * PDF output doesn't support...
         *
         * docx4j used to also support creating PDF via iText and via HTML. As
         * of docx4j 2.5.0, only viaXSLFO is supported. The viaIText and viaHTML
         * source code can be found in src/docx4j-extras directory
         *
         */
        /*
		 * NOT WORKING?
