...
/**
 * @author Renan Fucci  <a href="malito:renanfucci@hotmail.com">(renanfucci@hotmail.com)</a>
 * <br> A classe {@link EM_piramide} possui dois construtores.
 * <br> O construtor {@link EM_piramide#EM_piramide(BufferedImage)} vai fazer o
 * metodo da piramide ate que um dos lados seja menor que 400 px.
 * <br> O construtor {@link EM_piramide#EM_piramide(BufferedImage, int)} vai
 * fazer o metodo da piramide com o nivel passado como parâmetro.
 * <br> Para pegar o resultado da piramide, utilizando qualquer construtor
 * primeiro, utilizar o {@link EM_piramide#getImg_piramide()}.
 * <br> E possivel pegar o nivel real aplicado na imagem atraves do
 * {@link EM_piramide#getNivel()}.
 * <br> O {@link EM_piramide#remapearCords_img_pyrToOrig(int[][])} deve ser
 * usado, utilizando as cordenadas da imagem resultado da piramide e seu
 * respectivo nivel.
 * <br> É imperativo o uso da classe {@link ConfigurarOpenCV} por meio de
 * chamada estatica do construtor ou por herança da classe
 */
public class EM_piramide {

    private static final ConfigurarOpenCV cV = new ConfigurarOpenCV();
    ...
    /**
     * <b>@author Renan Fucci  <a href="malito:renanfucci@hotmail.com">(renanfucci@hotmail.com)</a><br></b>
     * <b>Construtor EM_piramide<br></b>
     * Contrutor que ira receber uma imagem {@link BufferedImage}, aplica o
     * nivel da pyramid ate que o menor dos lados (altura ou largura) seja maior
     * que 400 pixels.<br>
     * Obs.: Para pegar a imagem resultado da piramide usar
     * {@link EM_piramide#getImg_piramide()}}}
     *
     ...
     * Metodo para pegar o ponto correspondente da imagem menor na imagem maior
     * do metodo {@link #processDiscretePyramid(BufferedImage, int)}. <br>
     *
     * @param pontos matriz com os pontos da imagem pequena, podendo ser a
     * primeira <br>
     * coluna i|y ou j|x, isto é, não importa a ordem de inserção, contudo que
     * uma coluna seja sempre a mesma coordenada.;
     ...
     * Metodo para aplicar o metodo Pyramid da biblioteca OpenCV em uma imagem
     * com o nivel desejado.<br>
     *
     * @param image imagem a ser processada;
     * @param nível do metodo pyramid.
     * @return saida imagem resultante do metodo piramide e seu respectivo
     * nivel.
     */
    private BufferedImage processPyramid_OpenCV(BufferedImage image, int nivel_div_Two) {
        Mat source = bufferImgToMat(image); //ImgIn padrao OpenCV
     ...
     * Metodo para aplicar o metodo Pyramid da biblioteca OpenCV em uma imagem
     * com o nivel dinamico, entre 0 e 2, somente.<br>
     * Aplica o nivel da pyramid ate que o menor dos lados (altura ou largura)
     * seja maior que 400 pixels, contudo que o nivel esteja entre 0 e 2.
     *
     * @param image imagem a ser processada;
     * @return saida imagem resultante do metodo piramide e seu respectivo
     * nivel.
     ...
     */
    private Mat bufferImgToMat(BufferedImage img) {
