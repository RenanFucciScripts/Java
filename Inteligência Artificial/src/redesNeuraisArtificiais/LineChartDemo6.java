...
public class LineChartDemo6 extends ApplicationFrame {
    ...
    public LineChartDemo6(final String title) {
        ...
        chartPanel.setPreferredSize(new java.awt.Dimension(700, 600));//tamanho tela
...
//        final StandardLegend legend = (StandardLegend) chart.getLegend();
  //      legend.setDisplaySeriesShapes(true);
     ...
     * @param args  ignored.
     */
    public static void criarReta(double x2, ArrayList<double[][]> amostras) {
