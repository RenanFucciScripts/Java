...
public class Background_Correction_ implements PlugInFilter{
	...
	public static void main(String[] args)  {
		...
		ImagePlus imp = opener.openImage("C:\\Users\\Renan Fucci\\Dropbox\\RIO 45º\\testeQRCode\\020715000009525.jpg");  
		ImageProcessor ip= imp.getProcessor();

		Background_Correction_ bc =  new Background_Correction_();
		bc.run(ip);
	...
	public void run (ImageProcessor ip){
		...
		copy1.show();
		copy1.updateAndDraw();
		File file = new File("C:\\Users\\Renan Fucci\\Dropbox\\RIO 45º\\testeQRCode\\020715000009525_bg_Corretion.jpg");
		try {
			ImageIO.write(copy1.getBufferedImage(), "png", file);
		} catch (IOException e) {
	...
	BufferedImage autoAdjust(ImagePlus imp, ImageProcessor ip){
		double min, max;
