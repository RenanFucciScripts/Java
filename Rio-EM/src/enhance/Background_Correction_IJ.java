...
public class Background_Correction_IJ{
	...
	public static void main(String[] args) {
		...
		try {
			...
			File fl =  new File(dir+arq+".jpg");

			BufferedImage bufferedImage = new Background_Correction_IJ().limpaFundo(ImageIO.read(fl), 50, 50, true);
			File saida =  new File(dir+arq+"_BG_50_50.png");
			ImageIO.write(bufferedImage, "png", saida);
